...
procedure TForm2.N2Click(Sender: TObject);     //ƒќƒ≈Ћј“№ новый пользователь
var
i,i2:integer;
begin
close1:=1;
...
procedure TForm2.N3Click(Sender: TObject);    //учитель проверка
begin
Unit1.who:=1;
close1:=1;
 form1.Show;
